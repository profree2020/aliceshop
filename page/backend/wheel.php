...
?>
    <div class="container-sm bg-glass border border-2 mt-5 shadow-sm p-4 mb-4" data-aos="fade-down">
        <center>
            <h1 class="text-dark">&nbsp;<i class="fa-duotone fa-shopping-basket"></i>&nbsp;จัดการรางวัล</h1>
        </center>
        <hr>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-dark"><?php echo number_format($row['percent']); ?></td>
                            <td><a class="btn btn-warning text-dark w-100 col-4" style="width : 130px!important" href="?page=stock_wheel&id=<?php echo $row["id"]; ?>"><i class="fa-solid fa-box"></i>&nbsp;สต็อก</a></td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-lg-10 m-cent ">
                        <div class="mb-2">
                            <div class="mb-2">
                                <p class="text-secondary mb-1">ชื่อรางวัล <span class="text-danger">*</span></p>
                            ...
                            <div class="mb-2">
                                <p class="text-secondary mb-1">โอกาสออก สูงสุด 100% <span class="text-danger">*</span></p>
