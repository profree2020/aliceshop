...
?>
<div class="container-sm bg-white mt-5 shadow-sm p-4 mb-4" data-aos="fade-down">
    <center>
        <h1 class="text-main"><i class="fa-duotone fa-chart-simple"></i>&nbsp;หน้าแดชบอร์ด</h1>
    </center>
    <hr>
    <div class="row jusify-content-between mt-4">
        <div class="col-lg-4 mb-2">
            <div class="container-fluid p-4 shadow" style="border-bottom: 4px solid var(--main)!important;  border-radius: 10px;">
                <center>
                    <h1 class="text-main"><?php echo $month["total"];?>฿</h1>
                    <h5 class="text-main">ยอดการเติมในเดือนนี้</h5>
                </center>
            </div>
        </div>
        <div class="col-lg-4 mb-2">
            <div class="container-fluid p-4 shadow" style="border-bottom: 4px solid var(--main)!important;  border-radius: 10px;">
                <center>
                    <h1 class="text-main"><?php echo $day["total"];?>฿</h1>
                    <h5 class="text-main">ยอดการเติมในวันนี้</h5>
                </center>
            </div>
        </div>
        <div class="col-lg-4 mb-2">
            <div class="container-fluid p-4 shadow" style="border-bottom: 4px solid var(--main)!important;  border-radius: 10px;">
                <center>
                    <h1 class="text-main"><?php echo $topup["total"];?>฿</h1>
                    <h5 class="text-main">ยอดการเติมทั้งหมด</h5>
                </center>
            </div>
        </div>
        <div class="col-lg-4 mb-2">
            <div class="container-fluid p-4 shadow" style="border-bottom: 4px solid var(--main)!important;  border-radius: 10px;">
                <center>
                    <h1 class="text-main"><?php echo $box_month;?></h1>
                    <h5 class="text-main">ยอดกาารซื้อสินค้าเดือนนี้</h5>
                </center>
            </div>
        </div>
        <div class="col-lg-4 mb-2">
            <div class="container-fluid p-4 shadow" style="border-bottom: 4px solid var(--main)!important;  border-radius: 10px;">
                <center>
                    <h1 class="text-main"><?php echo $box_day;?></h1>
                    <h5 class="text-main">ยอดกาารซื้อสินค้าวันนี้</h5>
                </center>
            </div>
        </div>
        <div class="col-lg-4 mb-2">
            <div class="container-fluid p-4 shadow" style="border-bottom: 4px solid var(--main)!important;  border-radius: 10px;">
                <center>
                    <h1 class="text-white"><?php echo $box_all;?></h1>
                    <h5 class="text-main">ยอดกาารซื้อสินค้าทั้งหมด</h5>
                </center>
            </div>
        </div>
    </div>
