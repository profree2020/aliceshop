                ...
                <div class="bg-white shadow p-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb d-flex justify-content-center mt-3">
                            ...
                            <li class="breadcrumb-item active text-main" aria-current="page"><?= htmlspecialchars($row_1['name']) ?></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-6 p-3">
                            <div class="bg-glass shadow p-3 rounded">
                                <h3 class="text-main" style="text-decoration: none;">สินค้า : <b><?= htmlspecialchars($row_1['name']) ?><b></h3>
                                <div class="row mt-2">
                                    <div class="col">
                                        <hr>
                                    </div>
                                    <div class="col-auto text-main">รายละเอียดสินค้า</div>
                                    <div class="col">
                                        <hr>
                                    </div>
                                    <h5 class="text-main" style="word-wrap: break-word; white-space:pre-wrap;"><?= htmlspecialchars($row_1['des']) ?></h5>

                                    <div class="col">
                                        <hr>
                                    </div>
                                    <div class="col-auto text-main">จำนวนสินค้าที่จะซื้อ</div>
                                    <div class="col">
                                        <hr>
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-between pe-3 ps-3 mt-2">
                                        <span class="m-0 align-self-center text-main">สินค้าคงเหลือ <?= $count ?> ชิ้น</span>
                                        <span class="m-0 align-self-center text-main">ราคาสินค้า <?= $row_1['price'] ?> บาท</span>
                                    </div>
                                </div>
                                <button class="btn w-100 mt-2 text-black" id="shop-btn" onclick="buybox()" data-id="<?= $row_1['id'] ?>" data-name="<?= $row_1['name'] ?>" data-price="<?= $row_1['price'] ?>" style="background-color: var(--main);">สั่งซื้อสินค้า</button>
                            </div>
                        </div>
                    </div>
                </div>
